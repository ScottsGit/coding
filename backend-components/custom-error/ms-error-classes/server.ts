// https://github.com/yuangao0317/ms-rrts-at/blob/implement-gateway-auth-notification-2/ms/p02-auth-service/src/server.ts
  ...
  app.use(
    ...
    (
      ...
      if (error instanceof CustomError) {
        log.log(
          "error",
          `AuthService CustomError: ${error.comingFrom}:`,
          error
        );
